...
export function CaseStudies() {
  return (
    <section id="case-studies" className="scroll-mt-20 border-y border-border bg-card/20 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Case Studies" title={caseStudies.heading} subtitle={caseStudies.subtitle} />

        <RevealStagger className="mt-14 grid gap-6 lg:grid-cols-3">
          {caseStudies.items.map((cs) => (
            <RevealItem key={cs.industry} className="h-full">
              <article className="group flex h-full flex-col rounded-3xl border border-border bg-background/60 p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <div className="mt-5 flex flex-col gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-muted-foreground">{cs.problem}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-primary">Automation Built</p>
                    <p className="mt-1 text-sm leading-relaxed text-foreground">{cs.automation}</p>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-3 border-t border-border pt-5">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-foreground">{cs.hoursSaved}</p>
                      <p className="text-[11px] text-muted-foreground">Hours saved</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <DollarSign className="size-4 text-primary" />
                    <div>
                      <p className="text-sm font-semibold text-foreground">{cs.moneySaved}</p>
                      <p className="text-[11px] text-muted-foreground">Est. savings</p>
                    </div>
                  </div>
                </div>
